            ...
            <div className="space-y-8">
              ...
              {selectedLahan.catatanMitigasi && (
                <div className="bg-white/5 border border-white/5 rounded-[24px] p-5 md:p-6 shadow-xl">
                  <h4 className="font-bold text-white mb-3 text-xs uppercase tracking-widest text-gray-400 border-b border-white/5 pb-2">Panduan Umum Perawatan</h4>
    ...
    <div className="min-h-screen bg-[#050505] flex flex-col relative overflow-hidden">
      ...
      <main className="flex-grow pt-24 pb-12 max-w-6xl w-full mx-auto px-4 relative z-10">
        ...
        {activeAlerts.length > 0 && !isAlertDismissed && (
          <div className="bg-gradient-to-r from-red-500/10 to-transparent border-l-4 border-l-red-500 border-y border-r border-white/5 backdrop-blur-md rounded-r-2xl p-6 mb-10 flex items-start justify-between gap-4 shadow-lg relative">
            ...
            <button
              ...
              className="p-1.5 hover:bg-white/5 text-gray-400 hover:text-white rounded-lg transition-colors cursor-pointer shrink-0"
        ...
        <div id="daftar-lahan-section" className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-5">
